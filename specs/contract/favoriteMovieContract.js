...
const itsActsFavoriteMovieModel = (favoriteMovie) => {
  ...
  it('Can return all of the movie has been added', async () => {
    favoriteMovie.putMovie({ id: 1 });
    favoriteMovie.putMovie({ id: 2 });
  ...
  it('Should handle request to remove a movie even thought the movie has not been added', async () => {
    favoriteMovie.putMovie({ id: 1 });
    favoriteMovie.putMovie({ id: 2 });
    favoriteMovie.putMovie({ id: 3 });
  ...
  it('Should be able to search for Favorite Movies', async () => {
...
export { itsActsFavoriteMovieModel };
